...
# Settings screen lets the player switch between the dark and light themes.
def settings_screen():
    clear_screen()
    ...
    canvas.create_text(325 , 272 , text = "Light mode is easier to read in a bright room. Every race is " + str(questions_per_race) + " questions." , font = (font , 9) , fill = dim_text)
...
class Race:
    ...
    # Refreshes the clock once a second for as long as the race is being played.
    def tick(self):
    ...
    def show_scoreboard(self):
        ...
        self.canvas.itemconfig(self.scoreboard , text = self.difficulty.upper() + "    QUESTION " + str(showing) + " OF " + str(self.total) + "    SCORE " + str(self.score) + "    " + str(accuracy) + "% CORRECT    TIME " + format_time(self.seconds()))
