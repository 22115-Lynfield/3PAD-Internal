...
def race():
    ...
    # readable once the bike is sitting inside the gate.
    for lane in range(LANE_COUNT):
    ...
    def finish_race():
        ...
        race_canvas.itemconfig(instruction_txt, text="")
    ...
    def arrive():
        ...
        # Leave the message up for a moment so it can actually be read.
