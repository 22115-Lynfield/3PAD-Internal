...
# The race is drawn on a road rather than the yellow of the other windows.
ROAD_COLOUR = "#3a3a3a"
LANE_LINE_COLOUR = "#f2f2f2"
GATE_COLOUR = "#1f1f1f"
CORRECT_COLOUR = "#5ce08a"
WRONG_COLOUR = "#ff8080"
...
def race():
    ...
    race_canvas = Canvas(race_win, width=650, height=650, bg=ROAD_COLOUR)
    ...
    question_txt = race_canvas.create_text(325, QUESTION_Y, text="", font=("font", 15, "bold"), fill="white", width=610, justify=CENTER)
    scoreboard_txt = race_canvas.create_text(325, SCOREBOARD_Y, text="", font=("font", 12, "bold"), fill="yellow")
    feedback_txt = race_canvas.create_text(390, BOTTOM_ROW_Y, text="", font=("font", 13, "bold"), fill="white")
    ...
    for lane in range(LANE_COUNT):
        ...
        gate_texts.append(race_canvas.create_text(0, 0, text="", font=("font", 20, "bold"), fill="white"))
    ...
    def finish_race():
        ...
        race_canvas.itemconfig(feedback_txt, text=str(game.correct) + " of " + str(game.total) + " correct, " + str(game.accuracy()) + "% accuracy", fill="white")
    ...
    back_btn = Button(race_win, text=" Back", font=("font", 11), image=back_img, compound=LEFT, command=back)
...
play_btn = Button(root, text="Play", font=("font", 12), width=25, height=3, command=race)
